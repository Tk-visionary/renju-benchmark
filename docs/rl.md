...
nearby legal points. It also filters out moves that allow an immediate winning reply when there is a safer candidate.
This is the default direction for beating weak Rapfi; raw policy-only moves are mainly useful for debugging imitation
quality.
